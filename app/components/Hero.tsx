export default function Hero() {
  return (
    <section
      id="accueil"
      aria-label="Presentation principale"
      style={{
        position: 'relative',
        minHeight: '100vh',
        display: 'flex',
    ...
    >
      ...
      {/* Content */}
      <div className="container" style={{ position: 'relative', zIndex: 1, paddingBlock: '4rem' }}>
        <div style={{ maxWidth: '800px' }}>
          <h1 style={{
            ...
            ENTREPRISE DE R&Eacute;NOVATION<br />
            <span style={{ color: 'var(--color-accent)' }}>TOUS CORPS D&apos;&Eacute;TAT</span>
          </h1>
          ...
          <p style={{
            ...
            Nous vous accompagnons depuis plus de 20 ans dans vos projets de r&eacute;novation
            int&eacute;rieure et ext&eacute;rieure, de la maison individuelle aux locaux professionnels.
          </p>
